...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"GoGoMarket connecte les producteurs agricoles aux acheteurs"}],"link":[],"style":[],"script":[],"noscript":[],"title":"GoGoMarket - La marketplace des produits agricoles"};
